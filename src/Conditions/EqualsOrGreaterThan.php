...
/**
 * class EqualsOrGreaterThan.
 *
 * The EqualsOrGreaterThan condition allows the CondtionPipe to
 * check if the pipeline input equals or is greater than the given value.
 *
 ...
 * @since    0.1.0
 */
class EqualsOrGreaterThan implements ConditionInterface
{
    /**
